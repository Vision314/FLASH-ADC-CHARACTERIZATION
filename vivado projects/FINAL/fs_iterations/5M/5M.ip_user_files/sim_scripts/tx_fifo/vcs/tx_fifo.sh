...
#
# Script generated by Vivado on Wed Mar 18 11:08:22 EDT 2026
...
# script info
echo -e "tx_fifo.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tx_fifo xil_defaultlib.glbl -o tx_fifo_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tx_fifo_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/frankie/WCIS/WCIS-CMODA7-Control-Board/ROOT/wcis_adc_control/wcis_adc_control.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key tx_fifo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tx_fifo_simv.daidir vcs_lib c.obj)
...
Usage: tx_fifo.sh [-rerun]\n\
Usage: tx_fifo.sh [-reset_run]\n\
Usage: tx_fifo.sh [-clean]\n\
