...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xpm -L fifo_generator_v13_2_14 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot top_v4 xil_defaultlib.top_v4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top_v4 -key {Behavioral:sim_1:Functional:top_v4} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb top_v4.wdb xsim.dir libdpi.so)
