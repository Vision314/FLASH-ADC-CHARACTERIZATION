...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../../../Xilinix/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" \
  ...
  xmvlog -work fifo_generator_v13_2_14 $xmvlog_opts +incdir+"../../../../../../../../Xilinix/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../../../Xilinix/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.top_v3 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.top_v3 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log top_v3_sc.so .tmp_log xcelium_lib waves.shm c.obj)
