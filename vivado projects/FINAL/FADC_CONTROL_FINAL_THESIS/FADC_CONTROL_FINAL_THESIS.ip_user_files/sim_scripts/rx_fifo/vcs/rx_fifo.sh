...
#
# Script generated by Vivado on Mon Mar 16 23:33:47 EDT 2026
...
# script info
echo -e "rx_fifo.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../../../Xilinix/2025.2/data/rsb/busdef" \
  ...
  vlogan -work fifo_generator_v13_2_14 $vlogan_opts +v2k +incdir+"../../../../../../../../../../Xilinix/2025.2/data/rsb/busdef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../../../Xilinix/2025.2/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.rx_fifo xil_defaultlib.glbl -o rx_fifo_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./rx_fifo_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/frankie/WCIS/WCIS-CMODA7-Control-Board/sw/root/fw/updated_adc_operation_and_dac_works_frankie/updated_adc_operation_and_dac_works_frankie.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key rx_fifo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc rx_fifo_simv.daidir vcs_lib c.obj)
...
Usage: rx_fifo.sh [-rerun]\n\
Usage: rx_fifo.sh [-reset_run]\n\
Usage: rx_fifo.sh [-clean]\n\
