...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.tx_fifo xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.tx_fifo -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/frankie/WCIS/WCIS-CMODA7-Control-Board/ROOT/wcis_adc_control/wcis_adc_control.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log tx_fifo_sc.so .tmp_log xcelium_lib waves.shm c.obj)
