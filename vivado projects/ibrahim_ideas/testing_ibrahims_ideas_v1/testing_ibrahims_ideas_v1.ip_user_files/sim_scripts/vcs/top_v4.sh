...
#
# Script generated by Vivado on Mon Apr 13 23:02:54 EDT 2026
...
#
# Usage        : top_v4.sh
#                top_v4.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                top_v4.sh [-rerun]
#                top_v4.sh [-reset_run]
#                top_v4.sh [-clean]
#                top_v4.sh [-reset_log]
...
#                script (type 'top_v4.sh -help' for more information).
#
...
# script info
echo -e "top_v4.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./top_v4.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../Xilinix/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" \
  ...
  vlogan -work fifo_generator_v13_2_14 $vlogan_opts +v2k +incdir+"../../../../../../../../Xilinix/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../Xilinix/2025.2/data/rsb/busdef" +incdir+"../../ipstatic" \
  ...
  "../../../../../../vivado\\ projects/ibrahim_ideas/testing_ibrahims_ideas_v1/testing_ibrahims_ideas_v1.srcs/sources_1/imports/new/adc_control.v" \
  "../../../../../../vivado\\ projects/ibrahim_ideas/testing_ibrahims_ideas_v1/testing_ibrahims_ideas_v1.srcs/sources_1/imports/new/baud_match.v" \
  "../../../../../../vivado\\ projects/ibrahim_ideas/testing_ibrahims_ideas_v1/testing_ibrahims_ideas_v1.srcs/sources_1/new/debouncer.v" \
  "../../../../../../vivado\\ projects/ibrahim_ideas/testing_ibrahims_ideas_v1/testing_ibrahims_ideas_v1.srcs/sources_1/imports/new/rx.v" \
  "../../../../../../vivado\\ projects/ibrahim_ideas/testing_ibrahims_ideas_v1/testing_ibrahims_ideas_v1.srcs/sources_1/new/scan_chain_control.v" \
  "../../../../../../vivado\\ projects/ibrahim_ideas/testing_ibrahims_ideas_v1/testing_ibrahims_ideas_v1.srcs/sources_1/imports/new/tx.v" \
  "../../../../../../vivado\\ projects/ibrahim_ideas/testing_ibrahims_ideas_v1/testing_ibrahims_ideas_v1.srcs/sources_1/new/top_v4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.top_v4 xil_defaultlib.glbl -o top_v4_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./top_v4_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/frankie/WCIS/FLASH-ADC-CHARACTERIZATION/vivado"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key top_v4_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc top_v4_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./top_v4.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: top_v4.sh [-help]\n\
Usage: top_v4.sh [-step]\n\
Usage: top_v4.sh [-lib_map_path]\n\
Usage: top_v4.sh [-rerun]\n\
Usage: top_v4.sh [-reset_run]\n\
Usage: top_v4.sh [-clean]\n\
Usage: top_v4.sh [-reset_log]\n\
Usage: top_v4.sh [-keep_index]\n\
Usage: top_v4.sh [-noclean_files]\n\n\
