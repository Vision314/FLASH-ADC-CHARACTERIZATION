...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L fifo_generator_v13_2_14 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rx_fifo xil_defaultlib.rx_fifo xil_defaultlib.glbl -log elaborate.log
}
