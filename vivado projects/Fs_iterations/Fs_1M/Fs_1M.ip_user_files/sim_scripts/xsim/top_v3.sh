...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xpm -L fifo_generator_v13_2_14 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot top_v3 xil_defaultlib.top_v3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top_v3 -key {Behavioral:sim_1:Functional:top_v3} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/frankie/Xilinix/2025.2/data/xsim"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xpm fifo_generator_v13_2_14)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb top_v3.wdb xsim.dir libdpi.so)
