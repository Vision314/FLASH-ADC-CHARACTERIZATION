...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/frankie/WCIS/WCIS-CMODA7-Control-Board/sw/root/fw/updated_adc_operation_and_dac_works_frankie/updated_adc_operation_and_dac_works_frankie.cache/compile_simlib/riviera"
  fi
  if [[ ($lib_map_path != "") ]]; then
