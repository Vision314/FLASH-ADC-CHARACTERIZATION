...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/frankie/WCIS/WCIS-CMODA7-Control-Board/sw/root/fw/updated_adc_operation_and_dac_works_frankie/updated_adc_operation_and_dac_works_frankie.cache/compile_simlib/questa"
  fi
