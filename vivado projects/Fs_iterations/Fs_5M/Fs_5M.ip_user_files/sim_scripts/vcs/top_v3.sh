...
#
# Script generated by Vivado on Sat Mar 14 20:15:01 EDT 2026
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../../../Xilinix/2025.2/data/rsb/busdef" +incdir+"../../../dac_controller_frankie.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work fifo_generator_v13_2_14 $vlogan_opts +v2k +incdir+"../../../../../../../../Xilinix/2025.2/data/rsb/busdef" +incdir+"../../../dac_controller_frankie.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../../../Xilinix/2025.2/data/rsb/busdef" +incdir+"../../../dac_controller_frankie.gen/sources_1/ip/clk_wiz_0" \
  ...
  "../../../../../vivado\\ projects/dac_controller_frankie/dac_controller_frankie.srcs/sources_1/imports/new/adc_control.v" \
  "../../../../../vivado\\ projects/dac_controller_frankie/dac_controller_frankie.srcs/sources_1/imports/new/baud_match.v" \
  "../../../../../vivado\\ projects/dac_controller_frankie/dac_controller_frankie.srcs/sources_1/imports/new/tx.v" \
  "../../../../../vivado\\ projects/dac_controller_frankie/dac_controller_frankie.srcs/sources_1/imports/new/top_v3.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/frankie/WCIS/WCIS-CMODA7-Control-Board/sw/vivado"
  fi
